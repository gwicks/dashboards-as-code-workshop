...
class Common
{
     ...
     * @return Timeseries\PanelBuilder
     */
     ...
     * @param string $expression The PromQL query.
     * @return Prometheus\DataqueryBuilder
     */
    ...
    /**
     * Creates a Prometheus query pre-configured for range
     * vectors.
     * @param string $expression The PromQL query.
     * @return Prometheus\DataqueryBuilder
     */
     ...
     * @param string $expression The LogQL query.
     * @return Loki\DataqueryBuilder
     */
